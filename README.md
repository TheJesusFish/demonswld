...
FPGA compatible core of Toaplan Version 1 arcade hardware for [**MiSTerFPGA**](https://github.com/MiSTer-devel/Main_MiSTer/wiki) written by **Erin Olafson**. Based on OutZone schematics and verified against OutZone (TP-015 Conversion / TP-018).
...
- Additional toggle to enable a fourth mapped button for the "Slow Scroll" feature. See the "PCB Information" section for further information.
...
### No-DSP Patch Selection

- The no-DSP protection patch set is selected automatically by the MRA metadata for each supported ROM set. Region remains a normal DIP switch option.
